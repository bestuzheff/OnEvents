...
class TestHtmlRendering(unittest.TestCase):
    ...
    def test_render_event_full(
        ...
        mock_add_utm.return_value = (
            "https://register.com?utm=test"
        )
        mock_map_link.return_value = (
            "https://maps.yandex.ru/test"
        )
        ...
        self.assertIn(
            "calendar/2026-05-11-Конференция-1С.ics",
            result
        )
    ...
    def test_render_webinar(self):
        ...
        self.assertIn(
            "calendar/2026-07-01-Вебинар-по-ERP.ics",
            result
        )

        self.assertIn(
            'id="webinar-webinar.yml"',
            result
        )
